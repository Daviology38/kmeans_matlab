function [CI]=kmeans_ar_ci_test2(X,stand,prop,nclus,nsim);

% [CI]=kmeans_ar_ci_test2(X,stand,prop,nclus,nsim);
%
...
%
% L. Agel Jan 2015
% check for empty EOF filtering flag
...
for i=1:nsim;
    ...
    [CI(i)]=kmeans_ci2(XR(:,((i-1)*N)+1:i*N),[],[],nclus,nsim);
end
